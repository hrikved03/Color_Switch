...
The Color Switcher is a simple interactive web project built using HTML, CSS, and JavaScript.
It allows users to change the webpage background color by clicking on different colored boxes. Additionally, a hover-based interaction is implemented for the orange color box.

This project demonstrates fundamental concepts of DOM manipulation, event handling, and UI interaction in JavaScript.
...
Color-Switcher/
│
├── Color_Switcher.html   # Contains HTML, CSS, and JavaScript
